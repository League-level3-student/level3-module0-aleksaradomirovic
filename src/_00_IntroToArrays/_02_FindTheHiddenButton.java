...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		hiddenButton = new Random().nextInt(input);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(buttonClicked.getText() == "ME") {
			JOptionPane.showMessageDialog(null, "You won nothing but wasted time");
		} else {
			JOptionPane.showMessageDialog(null, "Try again, be less inept next time");
		}
